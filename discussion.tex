...
%TODO:Revamp feature rank results in the following way:
% 1. cluster B <=> everything else
% 2. cluster B <=> cluster C, different features
% 3. cluster B <=> cluster C, different features/overuse
% 4. cosine
...
bottom. Although each feature set has ten features ranked here, it's
actually two sets of five features, because these are differences. The
top five positive features are shown as are the top five negative
features.
...
This analysis will focus on cluster B, containing J\"amshog, \"Ossj\"o
...
Besides, the adverb patterns, co-ordinating conjunctions (code $++$)
