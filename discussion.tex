...
Notes: make a note on the methodology here: the parts of speech are
crude. Trigrams doesn't capture much of syntax at all. But it matches
pretty well the survey nature of this article and allows a fast check
of whether they match. (Also I should find the icefeat ranking, but
that would take some more work since it doesn't print them all.)
