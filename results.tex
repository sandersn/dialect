...
The features were ranked with two different kinds of normalisation:
frequency, and overuse. For feature types, ratio normalisation
produces the same values. So they are not included.
...
\subsection{JS-trigram with OveruseNormalisation}
