...
Leinonen and are the same those in \namecite{leinonen08}.
...
bottom. The clusters are given in table
\ref{feature-ranking-clusters}. Although each feature set has ten
