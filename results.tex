...
\begin{tabular}{r|cccc}
 & $R^2$ & $KL$ & $JS$ & cos \\ \hline
$R$ & 0.85 & 0.79 & 0.98 & 0.20 \\ 
$R^2$&& 0.7687 & 0.85 & 0.14 \\
$KL$ &&& 0.87 & 0.65 \\
$JS$ &&&& 0.34 \\
\end{tabular}
...
two. For example, figure \ref{cluster-r-dep-freq} and
\ref{cluster-r-dep-ratio} show the different clusters. Other
dendrograms based on $R$ are similar over feature set, but the
additional normalisation clearly makes a difference.

\begin{figure}
  \includegraphics[width=0.9\textwidth]{dist-10-1000-r-dep-freq-clusterward}
  \label{cluster-r-dep-freq}
  \caption{Dendrogram With Frequency Normalisation Only ($R$
    measure and Dependency features)}
\end{figure}

\begin{figure}
  \includegraphics[width=0.9\textwidth]{dist-10-1000-r-dep-ratio-clusterward}
  \label{cluster-r-dep-ratio}
...
\ref{cluster-js-dep-freq} and \ref{cluster-js-dep-ratio}.

\begin{figure}
  \includegraphics[width=0.9\textwidth]{dist-10-1000-js-dep-freq-clusterward}
  \label{cluster-js-dep-freq}
  \caption{Dendrogram With Frequency Normalisation Only
    (Jensen-Shannon measure and Dependency features)}
\end{figure}

\begin{figure}
  \includegraphics[width=0.9\textwidth]{dist-10-1000-js-dep-ratio-clusterward}
  \label{cluster-js-dep-ratio}
  \caption{Dendrogram With Ratio Normalisation (Jensen-Shannon
    measure and Dependency features)}
\end{figure}

TODO: Cosine agrees pretty well, too actually. Maybe it's just that
the distances are constrained 0 to 1? I don't think that would make so
