...
maps are produced. Next, multi-dimensional scaling gives a smoother
...
sites is the $435=30(30-1) / 2$. In the first set,
...
similar information to do their classification. This
...
job in eliminating size differences between interview sites. Future work
...
grouping sites. These groups can be compared to
...
features, comparing full sites. Those parameter settings produce the
...
1000-sentence samples of sites. Its dendrogram is in figure
...
between the sites on the top and bottom of the page is
...
\begin{sloppypar}
  ...
  are still comparable: if two sites are blue in one map and both
...
not be noticeable without counting a large amount of data; second, it can
point out rare features that only occur in one site. The
