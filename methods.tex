...
(that I don't *really* use) and half of it is stuff I actually use. But the dividing line
is in the wrong place; R and leaf-ancestor paths are presented as
history.

Probably I should break the first half into a background chapter and move it much
earlier in the dissertation. It might even be appropriate in the first
chapter, except that should be mostly an introduction I think.
...
How does it do this? I'm not really sure. I bet it's very impressive.

\subsubsection{PCA}

I think L04 does it for me. Probably.
