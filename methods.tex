...
Here is what Josh misunderstood: he thought that I was taking the top 3 features first from each set of features (which have the set of features normalised across sites, which I don't do, because to do this properly would obviate the need for MDS since I'd be working with a distance instead of a dissimilarity). But the top 3 would be different for each site pair. THEN he thought I was doing MDS.
...
\subsubsection{Alternate Training for}
