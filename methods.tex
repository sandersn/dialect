...
in the majority of dendrograms appear in the consensus tree.
...
TODO: Paste in the diagrams I made for the web site (or mimic them with
qtree, probably would fit better).

TODO:Can't find a good citation for this. The trail goes back to 1989
to some software but it obviously existed before then. I should start
from the biology paper I downloaded.
