...
\begin{figure}
  \includegraphics[width=0.46\textwidth]{hierarchical-cluster-1}
 \caption{Sites Before Clustering}
  \label{hierarchical-cluster-1}
\end{figure}

\begin{figure}
  \includegraphics[width=0.5\textwidth]{hierarchical-cluster-2}
 \caption{Sites After A-B Merge}
  \label{hierarchical-cluster-2}
\end{figure}

\begin{figure}
  \includegraphics[width=0.5\textwidth]{hierarchical-cluster-3}
 \caption{Sites After D-E Merge}
  \label{hierarchical-cluster-3}
\end{figure}

\begin{figure}
  \includegraphics[width=0.65\textwidth]{hierarchical-cluster-4}
 \caption{Sites After A-B-C Merge}
  \label{hierarchical-cluster-4}
\end{figure}

\begin{figure}
  \includegraphics[width=0.65\textwidth]{hierarchical-cluster-5}
...
\item \{ A B C D E \}
\end{itemize}
\caption{First tree's spans}
\label{consensus-tree-spans-1}
\end{figure}
...
\item \{ A B C D E \}
\end{itemize}
\caption{Second tree's spans}
\label{consensus-tree-spans-2}
\end{figure}
...
\begin{figure}
  ...
  \item \{ A B C D E \}
  \end{itemize}
  \caption{Third tree's spans}
  \label{consensus-tree-spans-3}
\end{figure}
...
from the biology paper I downloaded. (I will have to cite them anyway
because I used their example but with a more compact tree setup.)

TODO: Those itemizes should be tabulars.
