...
** 2010/01/19
   ...
   - Still need to mail Rosenkvist and Sprouse.
     ...
     I have attached my proposal. I guess the next step is to have a
     proposal defense in the next week or two. Sandra tells me that I
     should present my current progress and then what I plan to do for
     {the rest of the} dissertation, so I will plan on that and then
     take questions.

     Please let me know what times you prefer. My
     schedule is obviously flexible, but Tuesday makes a nice default
     since I will already be on campus for CL Lunch. Of course that's
...
**** TODO Try paths of dependency labels instead of POSs
...
clusters I think)
    ...
    current syntax papers in Swedish dialectology. 'His' page on Lunds
