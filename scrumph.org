...
*** TODO Just normal phrase-structure rules
    They were not cool enough for me before. But they are easy so why not.
*** TODO Phrase-structure rules, plus grandparent
    used by Collins and Koo -- parse reranking (around 2005)
** parsing
*** TODO Get TnT to mark unknown words
    See what they are, then see if a human annotator could fill them
    in (in a reasonable time) (or Rex, if there aren't many and it
    would be easy)
*** TODO Ask Henrik for updated corpus
** Swedish
*** TODO Find out how householder fund words.
    How to get money from it?
    Pay a swedish undergrad to annotate either dialect sentences or
    parts of speech
*** TODO Check to see if Kari Gaade (Gade?) is Swedish? She does syntax?
** Analysis
...
*** TODO Ask Therese for improved eps outline of Sweden
