...
combining features of different types. The most obvious approach should work, dumping
them all into the same bucket, because they are just weights and
features of the same type {\it already} contain redundant information. If
this turns out to be insufficient, I will find a more complex and
sound way to combine features.
