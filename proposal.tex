...
1 paragraph explanation of dialectology/dialectometry goes
here. Surely I have one somewhere around here. If not, it should be
easy to write a new one\ldots

Past work, with the question that it raises (and anything it answers too)
Questions (or maybe problems). This might go to 3 or 4 paragraphs,
about one per each.
