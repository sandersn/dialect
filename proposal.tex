...
\end{array} \right.}
  ...
  TODO: Put a transitional paragraph here. Expand the first hypothesis.

$R$ will agree substantially with the results of dialectology with respect
to syntax. This can be tested by extracting the highly ranked features
