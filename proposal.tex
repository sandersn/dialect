...
that it detects dialect differences, but as yet there has not been
...
\cite{nerbonne06}. Their experiment compared two generations of
Norwegian L2 speakers of English. Nerbonne and Wiersma used $R$ from
\namecite{kessler01}, together with a test for statistical
significance. They used part-of-speech trigrams as features for input
to $R$. They found that the two generations were significantly
...
showing that two generations are significantly different with respect
to $R$ does not necessarily imply that the same will be true for two
other language varieties. Specifically, two generations of L2 speakers
is not necessarily the same as two different dialects.
