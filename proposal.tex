...
method of combination will be needed instead.
...
structure may be useful too, such as features extracted from
dependency parses
...
Hypothesis 1: The features found by dialectologists should agree with
...
literature. In addition, $R$ will agree substantially with the
