...
To investigate the second hypothesis, I need a method to combine features
(?.?) and back off sparse features (?.?). I also need a way to
...
possibilities; Kullbeck-Leibler divergence or maximum (?) entropy
among them.
