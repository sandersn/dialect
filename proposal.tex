...
\namecite{nerbonne06}. Dialectometry has existed as a field since
\namecite{seguy73}, which came into existence as a sub-field of
dialectology, which has existed for much longer
\cite{chambers92}. Computational methods have come to dominate
dialectometry, but they are limited in focus compared to previous
work; most have explored phonological distance only, while earlier
methods integrated phonological, lexical, and syntactic data.
...
\begin{enumerate}
\item Rewrite phonolgy paragraph.
...
sentences of SweDiaSyn. MaltParser and the pre-trained Talbanken05
model provided
by Hall, Nilsson \& Nivre will be used for this
purpose. (CITE:various MaltParser papers)
